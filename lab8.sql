...
CREATE VIEW order_SM_Cust AS SELECT s.name, c.cust_name from salesman as s INNER JOIN customers as c USING (c.customer_id=orders.customer_id AND s.salesman_id= orders.salesman_id); 
